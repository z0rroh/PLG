                ...
                <div className="box">
                  <div className="row start-lg">
                    <div className="col-lg-12" >
                      <h5 className="Anuncio-User pt-skeleton">{anuncio.autor.name}</h5>
                    </div>
                    <div className="col-lg-12">
                      <h6 className="Anuncio-Time pt-skeleton">{anuncio.fecha}</h6>
                    </div>
                    <div className="col-lg-12">
                      <p className="Anuncio-Text pt-skeleton">{anuncio.text}</p>
                    </div>
                  </div>
                </div>
              </div>
