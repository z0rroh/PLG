...
class AnuncioItem extends Component {
  ...
  componentWillMount(){
    io.socket.on('comentario', function serverSentEvent(comentario) {
      let newComment= {autor: comentario.data.autor, id: comentario.data.id, text: comentario.data.text, fecha: comentario.data.fecha}
        ...
        <div className="Anuncio" id={anuncio.id}>
          <div className="row start-lg">
            <div className="Anuncio-container col-lg-12">
              <div className="Anuncio-Image col-lg"><img src={"/images/avatars/default_user.png"}/></div>
