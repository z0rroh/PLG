      ...
      <div className="Semana col-lg-12">
        <div className="SemanaTitle">
          <div className="row between-lg">
            <div className="col-lg-4 col-xs-12"><p> Hoy: {this.state.fecha}</p></div>
          <div className="col-lg-2 col-xs-12"><p> Hora: </p></div>
        <div className="col-lg-2 col-xs-12"><p>  Tokens: {this.state.tokens}</p></div>
